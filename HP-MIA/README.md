...
We have only provided models trained on Purchase100. If you want to test on other datasets, you need to refer to `Train_ref_Purchase.ipynb` to train your own model.
